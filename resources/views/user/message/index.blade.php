                    ...
                    <div class="card-body">
                        <div class="inbox-leftbar">
                            ...
                            <div class="mail-list mt-4">
                                <a href="{{ route('user.message.index') }}" class="list-group-item border-0 text-danger"><i class="fa fa-inbox font-18 align-middle mr-2"></i>Inbox @if($unread > 0) <span class="label label-danger float-right ml-2">{{ $unread }}</span> @endif</a>
                                <a href="{{ route('user.message.send') }}" class="list-group-item border-0"><i class="fa fa-send font-18 align-middle mr-2"></i>Sent Message</a>
                            </div>
                        </div>
...
@section('script')
    <script>
        $(document).ready(function(){
            var routeUrl = "{{ route('user.read.message') }}";
            $.get(routeUrl);
        });
    </script>
