    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Order List &nbsp;
                <a href="{{ route('user.order') }}" style="font-size: 18px;color: #007bff;"><i class="fa fa-th-large"></i></a>&nbsp;
                <a href="{{ route('user.order.list') }}" style="font-size: 18px;"><i class="fa fa-list-ul"></i></a>
            </h3>
        </div>
