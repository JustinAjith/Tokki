...
@section('content')
    ...
    <div class="row page-titles">
        <div class="col-md-5 align-self-center">
            <h3 class="text-primary">Delete Product List</h3> </div>
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">Delete Product List</li>
            </ol>
        </div>
    </div>
                        ...
                        <div class="row">
                            @foreach($products as $product)
                                <div class="col-3 mb-3">
                                    <a href="{{ route('admin.delete.product.show', $product->id) }}">
