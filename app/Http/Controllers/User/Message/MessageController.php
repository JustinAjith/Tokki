...
class MessageController extends Controller
{
    public function index()
    {
        ...
        $messages = Message::where(['user_id'=>Auth::user()->id, 'admin_id'=>null])->orderBy('id', 'DESC')->paginate(22);
    ...
    {
        $unread = $this->unReadMessage();
        $messages = Message::where('user_id', Auth::user()->id)->where('admin_id', '!=', null)->orderBy('id', 'DESC')->paginate(22);
